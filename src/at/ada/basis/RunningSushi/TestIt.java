...
public class TestIt {
    public static void main(String[] args) {
        ...
        System.out.println(band.getiSushiAufBand());
        ...
        for (int i = 1; i <= 100; i++) {
            ...
            // don't forget array zugriff mit array start bei 0!!!!
        ...
        for (Sushi a : aSushiList) {
            ...
            band.addSushiAufBand(a);
            System.out.println(band.getiSushiAufBand() + " Stück - frei " + band.getFreiePlaetze());
        }
